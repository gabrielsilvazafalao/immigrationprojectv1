            ...
            <div class="container">
                <div class="row center">
                    ...
                    <div class="col-sm-8 col-sm-offset-2">
                        ...
                        <form action="ex_login.php" id="login" method="post">
                            <div class="row">
                                <div class="form-group">

                                    <div class="col-sm-6">
                                        <label>Email<span class="required">*</span></label>
                                        <input type="email" value="<?php echo isset($_COOKIE['email']) ? $_COOKIE['email'] : ""; ?>" class="form-control" name="email" id="email1" required>
                                    </div>

                                    <div class="col-sm-6">
                                        <label>Password<span class="required">*</span></label>
                                        <input type="password" value="<?php echo isset($_COOKIE['password']) ? $_COOKIE['password'] : ""; ?>" class="form-control" name="password" id="password" required>
                                    </div>
                    ...
                    <div class="remeberme" ><input type="checkbox" name="remember" checked> Remeber me</div>
                        <button name="submit" onclick="document.getElementById('login').submit();" type="button" id="sendmesage" class="btn v-btn no-three-d">Entrar</button>
                        <!--
                            <button name="cookie" onclick="funcsetcookiejs();" id="cookieset" class="btn v-btn no-three-d">Lembrar Login</button>
                            <button name="cookie" onclick="funcunsetcookiejs();" id="cookieinset" class="btn v-btn no-three-d">Esquecer Login</button>
                        -->
                    </div>
                </div>
