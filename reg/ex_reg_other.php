                ...
                <div class="container">
                    <div class="row center">
                        ...
                        <div class="col-sm-8 col-sm-offset-2">
                            ...
                            $confemaildb = "SELECT * FROM `user` WHERE `email` = '$email'";
                            ...
                            if ($rowsn != 0)
                            {
                                ...
                                if(!$send_mail) {
                                    ...
                                    $sql="INSERT INTO `log_other` (`id_user`, `name`, `adress`, `number`, `country`, `city`, `cpf`, `email`, `datebirthday`, `office`, `payment`) VALUES (NULL, '$name', ' ', ' ', '$country', ' ', '$cpf', '$email', '$datanascimento', '$cargo', '$pagamento' )";
