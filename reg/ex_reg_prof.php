                ...
                <div class="container">
                    <div class="row center">
                        ...
                        <div class="col-sm-8 col-sm-offset-2">
                            ...
                            $confemaildb = "SELECT * FROM `log_prof` WHERE `email` = '$email'; ";
                            ...
                            if ($rowsn == 0)
                            {
                                ...
                                */
                                    ...
                                    $sql="INSERT INTO `log_prof` (`id_prof`, `name`, `email`, `id_office`, `id_pclass`, 
                                    `id_payment`, `cpf`, `datebirthday`, `id_country`, `city`, `address`, `number`)
                                    VALUES (NULL, '$name', '$email', '$cargo', ' ', '$pagamento', '$cpf', '$datanascimento', ' ', ' ', ' ', ' ');";
                                    ...
                                    {
                                        $sqlselect = "SELECT `id_prof` FROM `log_prof` WHERE `email` = '$email'";
                                        $resultado_select = mysqli_query($ligacao, $sqlselect);
                                        $registo = mysqli_fetch_array($resultado_select);
                                        $codeuser = $registo['id_prof'];
                                        //echo $codeuser;
                                        
                                        $sqlinsert = "INSERT INTO `p_conf` (`id_pconf`, `id_log`, `code`, `conf_code`, `contaativa`, `password`) VALUES (NULL, '$codeuser', '$codeemail', ' ', ' ', '$pass_crypt');";
                                ...
                                echo 'Não foi possivel fazer registro!';
